  ...
  return (
    <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
      <form onSubmit={onSubmit} className="flex-1 flex flex-col gap-4" noValidate>
        <h2 className="text-sm font-semibold uppercase tracking-wide text-content-muted">Shipping details</h2>
        {FIELDS.map((f) => (
          <label key={f.name} className="flex flex-col gap-1 text-sm">
            ...
            <input
              ...
              className="rounded-md border border-line px-3 py-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-700"
            />
          </label>
        ))}
        ...
        <button
          type="submit"
          disabled={pending}
          className="mt-2 inline-flex w-fit items-center justify-center rounded-md bg-primary-500 px-5 py-2.5 text-sm font-medium text-surface hover:bg-primary-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-700 disabled:opacity-50"
        >
      ...
      <aside className="w-full shrink-0 rounded-lg border border-line bg-surface p-6 lg:w-80">
        <h2 className="mb-4 text-sm font-semibold uppercase tracking-wide text-content-muted">Order review</h2>
